...
export default function VendorProductsPage() {
  ...
  const fetchProducts = async () => {
    try {
      const data = await api.get<{ products: VendorProduct[] }>(
        "/api/vendor/products",
      );
    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Button
          ...
          className="bg-ig-green hover:bg-ig-green/90 text-white gap-1.5"
        >
      ...
      {showForm && (
        <div className="bg-white border border-border rounded-lg p-6 mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <ImageUpload
              onImageUpload={(url) => setForm({ ...form, thumbnail: url })}
                ...
                {filtered.map((product) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-center">
                      <span
                        className={`inline-block px-2 py-0.5 rounded-full text-xs font-medium ${product.is_active ? "bg-ig-green-light text-ig-green" : "bg-muted text-muted-foreground"}`}
                      >
                    ...
                    <td className="px-4 py-3 text-right">
                      <div className="flex items-center justify-end gap-1">
                        ...
                        <button
                          ...
                          className="p-1.5 text-muted-foreground hover:text-ig-red transition-colors"
